(function() {
  ...
  var offcanvasMenu = function() {
    ...
    $("#page").prepend(
      '<a href="#" class="js-my-nav-toggle my-nav-toggle my-nav-white"><i></i></a>'
    );
  ...
  var tabs = function() {
    // Auto adjust height
    $(".my-tab-content-wrap").css("height", 0);
    var autoHeight = function() {
      setTimeout(function() {
        var tabContentWrap = $(".my-tab-content-wrap"),
          tabHeight = $(".my-tab-nav").outerHeight(),
    ...
    // Click tab menu
    $(".my-tab-nav a").on("click", function(event) {
      var $this = $(this),
        tab = $this.data("tab");
  ...
  var sliderMain = function() {
    ...
    $("#my-hero .flexslider .slides > li").css("height", $(window).height());
    $(window).resize(function() {
      $("#my-hero .flexslider .slides > li").css("height", $(window).height());
    });
  };
